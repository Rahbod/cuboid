...
class ContentController extends Controller{
    ...
    public function show($id,$type){
        ...
        return view('main_site.pages.content.content_show')->with(['categories' => $categories, 'content' => $content, 'faqs' => $faqs, 'sub_page' => 'subPage']);
    }
    ...
    public function contents($type,$category_id = null)
    {
        ...
        return view('main_site.pages.content.contents')->with(['categories' => $categories, 'contents' => $contents, 'faqs' => $faqs, 'sub_page' => 'subPage', 'type' => $type]);
    }
