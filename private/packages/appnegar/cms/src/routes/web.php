    ...
    Route::group(['namespace'=>'Controllers\Admin','prefix'=>'{lang}'],function(){
        ...
        Route::group(['prefix'=>'admin','middleware'=>['auth:admin','set_department:admin' ,'user_info','lang','remove_additional_params']],function(){
                                                            ...
                                                            Route::get('/pages/get_actions', ['uses' =>'PageController@getActions','as' =>'admin.Page.get_actions']);
                                                                                Route::get('/pages', ['uses' =>'PageController@index','as' =>'admin.Page.index'])->middleware('acl:129');
                                                                                Route::get('/pages/list-view', ['uses' =>'PageController@listView','as' =>'admin.Page.list_view'])->middleware('acl:130');
                                                                                Route::get('/pages/create', ['uses' =>'PageController@create','as' =>'admin.Page.create'])->middleware('acl:131');
                                                                                Route::post('/pages', ['uses' =>'PageController@create','as' =>'admin.Page.store'])->middleware('acl:131');
                                                                                Route::get('/pages/{id}', ['uses' =>'PageController@show','as' =>'admin.Page.show'])->middleware('acl:132');
                                                                                Route::get('/pages/{id}/edit', ['uses' =>'PageController@edit','as' =>'admin.Page.edit'])->middleware('acl:133');
                                                                                Route::put('/pages/{id}', ['uses' =>'PageController@edit','as' =>'admin.Page.update'])->middleware('acl:133');
                                                                                Route::delete('/pages/{id}', ['uses' =>'PageController@destroy','as' =>'admin.Page.destroy'])->middleware('acl:134');
                                                                                Route::get('/pages/file_manager/connector', ['uses' =>'PageController@showFileManagerConnector','as' =>'admin.Page.showFileManagerConnector'])->middleware('acl:135');
                                                                                Route::post('/pages/file_manager/connector', ['uses' =>'PageController@showFileManagerConnector','as' =>'admin.Page.showFileManagerConnector'])->middleware('acl:135');
                                                                                Route::get('/pages/file_manager/{view}/{input_id?}', ['uses' =>'PageController@showFileManager','as' =>'admin.Page.showFileManager'])->middleware('acl:136');
                                                                                Route::get('/pages/comments', ['uses' =>'PageController@indexComment','as' =>'admin.Page.indexComment'])->middleware('acl:137');
                                                                                Route::get('/pages/comments/list-view', ['uses' =>'PageController@CommentsListView','as' =>'admin.Page.CommentsListView'])->middleware('acl:138');
                                                                                Route::get('/pages/comments/{id}/edit', ['uses' =>'PageController@editComment','as' =>'admin.Page.editComment'])->middleware('acl:139');
                                                                                Route::put('/pages/comments/{id}', ['uses' =>'PageController@editComment','as' =>'admin.Page.editComment'])->middleware('acl:139');
                                                                                Route::get('/pages/comments/{id}', ['uses' =>'PageController@showComment','as' =>'admin.Page.showComment'])->middleware('acl:140');
                                                                                Route::delete('/pages/comments/{id}', ['uses' =>'PageController@destroyComment','as' =>'admin.Page.destroyComment'])->middleware('acl:141');
                                                                                Route::get('/pages/settings/form', ['uses' =>'PageController@updateSettings','as' =>'admin.Page.updateSettings'])->middleware('acl:142');
                                                                                Route::put('/pages/settings/update', ['uses' =>'PageController@updateSettings','as' =>'admin.Page.updateSettings'])->middleware('acl:142');
                                                                                
                        
                                                            Route::get('/slider_groups/get_actions', ['uses' =>'SliderGroupController@getActions','as' =>'admin.SliderGroup.get_actions']);
                                                                                Route::get('/slider_groups', ['uses' =>'SliderGroupController@index','as' =>'admin.SliderGroup.index'])->middleware('acl:144');
                                                                                Route::get('/slider_groups/list-view', ['uses' =>'SliderGroupController@listView','as' =>'admin.SliderGroup.list_view'])->middleware('acl:145');
                                                                                Route::get('/slider_groups/create', ['uses' =>'SliderGroupController@create','as' =>'admin.SliderGroup.create'])->middleware('acl:146');
                                                                                Route::post('/slider_groups', ['uses' =>'SliderGroupController@create','as' =>'admin.SliderGroup.store'])->middleware('acl:146');
                                                                                Route::get('/slider_groups/{id}', ['uses' =>'SliderGroupController@show','as' =>'admin.SliderGroup.show'])->middleware('acl:147');
                                                                                Route::get('/slider_groups/{id}/edit', ['uses' =>'SliderGroupController@edit','as' =>'admin.SliderGroup.edit'])->middleware('acl:148');
                                                                                Route::put('/slider_groups/{id}', ['uses' =>'SliderGroupController@edit','as' =>'admin.SliderGroup.update'])->middleware('acl:148');
                                                                                Route::delete('/slider_groups/{id}', ['uses' =>'SliderGroupController@destroy','as' =>'admin.SliderGroup.destroy'])->middleware('acl:149');
                                                
                                                            Route::get('/sliders/get_actions', ['uses' =>'SliderController@getActions','as' =>'admin.Slider.get_actions']);
                                                                                Route::get('/sliders', ['uses' =>'SliderController@index','as' =>'admin.Slider.index'])->middleware('acl:151');
                                                                                Route::get('/sliders/list-view', ['uses' =>'SliderController@listView','as' =>'admin.Slider.list_view'])->middleware('acl:152');
                                                                                Route::get('/sliders/create', ['uses' =>'SliderController@create','as' =>'admin.Slider.create'])->middleware('acl:153');
                                                                                Route::post('/sliders', ['uses' =>'SliderController@create','as' =>'admin.Slider.store'])->middleware('acl:153');
                                                                                Route::get('/sliders/{id}', ['uses' =>'SliderController@show','as' =>'admin.Slider.show'])->middleware('acl:154');
                                                                                Route::get('/sliders/{id}/edit', ['uses' =>'SliderController@edit','as' =>'admin.Slider.edit'])->middleware('acl:155');
                                                                                Route::put('/sliders/{id}', ['uses' =>'SliderController@edit','as' =>'admin.Slider.update'])->middleware('acl:155');
                                                                                Route::delete('/sliders/{id}', ['uses' =>'SliderController@destroy','as' =>'admin.Slider.destroy'])->middleware('acl:156');
                                                                                Route::get('/sliders/file_manager/connector', ['uses' =>'SliderController@showFileManagerConnector','as' =>'admin.Slider.showFileManagerConnector'])->middleware('acl:157');
                                                                                Route::post('/sliders/file_manager/connector', ['uses' =>'SliderController@showFileManagerConnector','as' =>'admin.Slider.showFileManagerConnector'])->middleware('acl:157');
                                                                                Route::get('/sliders/file_manager/{view}/{input_id?}', ['uses' =>'SliderController@showFileManager','as' =>'admin.Slider.showFileManager'])->middleware('acl:158');
                                                                                Route::get('/sliders/settings/form', ['uses' =>'SliderController@updateSettings','as' =>'admin.Slider.updateSettings'])->middleware('acl:159');
                                                                                Route::put('/sliders/settings/update', ['uses' =>'SliderController@updateSettings','as' =>'admin.Slider.updateSettings'])->middleware('acl:159');
                                                                                
                        
                                                            Route::get('/tags/get_actions', ['uses' =>'TagController@getActions','as' =>'admin.Tag.get_actions']);
                                                                                Route::get('/tags', ['uses' =>'TagController@index','as' =>'admin.Tag.index'])->middleware('acl:161');
                                                                                Route::get('/tags/list-view', ['uses' =>'TagController@listView','as' =>'admin.Tag.list_view'])->middleware('acl:162');
                                                                                Route::get('/tags/create', ['uses' =>'TagController@create','as' =>'admin.Tag.create'])->middleware('acl:163');
                                                                                Route::post('/tags', ['uses' =>'TagController@create','as' =>'admin.Tag.store'])->middleware('acl:163');
                                                                                Route::get('/tags/{id}', ['uses' =>'TagController@show','as' =>'admin.Tag.show'])->middleware('acl:164');
                                                                                Route::get('/tags/{id}/edit', ['uses' =>'TagController@edit','as' =>'admin.Tag.edit'])->middleware('acl:165');
                                                                                Route::put('/tags/{id}', ['uses' =>'TagController@edit','as' =>'admin.Tag.update'])->middleware('acl:165');
                                                                                Route::delete('/tags/{id}', ['uses' =>'TagController@destroy','as' =>'admin.Tag.destroy'])->middleware('acl:166');
                                                                                
                        
                                                            Route::get('/static_menus/get_actions', ['uses' =>'StaticMenuController@getActions','as' =>'admin.StaticMenu.get_actions']);
                                                                                Route::get('/static_menus', ['uses' =>'StaticMenuController@index','as' =>'admin.StaticMenu.index'])->middleware('acl:168');
                                                                                Route::get('/static_menus/list-view', ['uses' =>'StaticMenuController@listView','as' =>'admin.StaticMenu.list_view'])->middleware('acl:169');
                                                                                Route::get('/static_menus/create', ['uses' =>'StaticMenuController@create','as' =>'admin.StaticMenu.create'])->middleware('acl:170');
                                                                                Route::post('/static_menus', ['uses' =>'StaticMenuController@create','as' =>'admin.StaticMenu.store'])->middleware('acl:170');
                                                                                Route::get('/static_menus/{id}', ['uses' =>'StaticMenuController@show','as' =>'admin.StaticMenu.show'])->middleware('acl:171');
                                                                                Route::get('/static_menus/{id}/edit', ['uses' =>'StaticMenuController@edit','as' =>'admin.StaticMenu.edit'])->middleware('acl:172');
                                                                                Route::put('/static_menus/{id}', ['uses' =>'StaticMenuController@edit','as' =>'admin.StaticMenu.update'])->middleware('acl:172');
                                                                                Route::delete('/static_menus/{id}', ['uses' =>'StaticMenuController@destroy','as' =>'admin.StaticMenu.destroy'])->middleware('acl:173');
                                                                                
                        
                                                            Route::get('/attachments/get_actions', ['uses' =>'AttachmentController@getActions','as' =>'admin.Attachment.get_actions']);
                                                                                Route::get('/attachments', ['uses' =>'AttachmentController@index','as' =>'admin.Attachment.index'])->middleware('acl:175');
                                                                                Route::get('/attachments/list-view', ['uses' =>'AttachmentController@listView','as' =>'admin.Attachment.list_view'])->middleware('acl:176');
                                                                                Route::get('/attachments/create', ['uses' =>'AttachmentController@create','as' =>'admin.Attachment.create'])->middleware('acl:177');
                                                                                Route::post('/attachments', ['uses' =>'AttachmentController@create','as' =>'admin.Attachment.store'])->middleware('acl:177');
                                                                                Route::get('/attachments/{id}', ['uses' =>'AttachmentController@show','as' =>'admin.Attachment.show'])->middleware('acl:178');
                                                                                Route::get('/attachments/{id}/edit', ['uses' =>'AttachmentController@edit','as' =>'admin.Attachment.edit'])->middleware('acl:179');
                                                                                Route::put('/attachments/{id}', ['uses' =>'AttachmentController@edit','as' =>'admin.Attachment.update'])->middleware('acl:179');
                                                                                Route::delete('/attachments/{id}', ['uses' =>'AttachmentController@destroy','as' =>'admin.Attachment.destroy'])->middleware('acl:180');
                                                                                Route::get('/attachments/file_manager/connector', ['uses' =>'AttachmentController@showFileManagerConnector','as' =>'admin.Attachment.showFileManagerConnector'])->middleware('acl:181');
                                                                                Route::post('/attachments/file_manager/connector', ['uses' =>'AttachmentController@showFileManagerConnector','as' =>'admin.Attachment.showFileManagerConnector'])->middleware('acl:181');
                                                                                Route::get('/attachments/file_manager/{view}/{input_id?}', ['uses' =>'AttachmentController@showFileManager','as' =>'admin.Attachment.showFileManager'])->middleware('acl:182');
                                                                                Route::get('/attachments/settings/form', ['uses' =>'AttachmentController@updateSettings','as' =>'admin.Attachment.updateSettings'])->middleware('acl:183');
                                                                                Route::put('/attachments/settings/update', ['uses' =>'AttachmentController@updateSettings','as' =>'admin.Attachment.updateSettings'])->middleware('acl:183');
                                                            ...
                                                            Route::get('/settings', ['uses' =>'SettingController@index','as' =>'admin.site_management.Setting.index'])->middleware('acl:185');
                                                                                Route::get('/settings/update_all_settings', ['uses' =>'SettingController@updateAllSettings','as' =>'admin.Setting.updateAllSettings'])->middleware('acl:186');
                                                                                Route::put('/settings/update_all_settings', ['uses' =>'SettingController@updateAllSettings','as' =>'admin.Setting.updateAllSettings'])->middleware('acl:186');
                                                                                
                        
                                                            Route::get('/feedback/get_actions', ['uses' =>'FeedbackController@getActions','as' =>'admin.Feedback.get_actions']);
                                                                                Route::get('/feedback', ['uses' =>'FeedbackController@index','as' =>'admin.Feedback.index'])->middleware('acl:188');
                                                                                Route::get('/feedback/list-view', ['uses' =>'FeedbackController@listView','as' =>'admin.Feedback.list_view'])->middleware('acl:189');
                                                                                Route::get('/feedback/create', ['uses' =>'FeedbackController@create','as' =>'admin.Feedback.create'])->middleware('acl:190');
                                                                                Route::post('/feedback', ['uses' =>'FeedbackController@create','as' =>'admin.Feedback.store'])->middleware('acl:190');
                                                                                Route::get('/feedback/{id}', ['uses' =>'FeedbackController@show','as' =>'admin.Feedback.show'])->middleware('acl:191');
                                                                                Route::get('/feedback/{id}/edit', ['uses' =>'FeedbackController@edit','as' =>'admin.Feedback.edit'])->middleware('acl:192');
                                                                                Route::put('/feedback/{id}', ['uses' =>'FeedbackController@edit','as' =>'admin.Feedback.update'])->middleware('acl:192');
                                                                                Route::delete('/feedback/{id}', ['uses' =>'FeedbackController@destroy','as' =>'admin.Feedback.destroy'])->middleware('acl:193');
                                                                            });
