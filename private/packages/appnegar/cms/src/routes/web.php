...
Route::group(['namespace' => 'Controllers\Admin', 'prefix' => '{lang}'], function () {
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'set_department:admin', 'user_info', 'lang', 'remove_additional_params']], function () {
        ...
        Route::get('/faqs/get_actions', ['uses' => 'FaqController@getActions', 'as' => 'admin.Faq.get_actions']);
        Route::get('/faqs', ['uses' => 'FaqController@index', 'as' => 'admin.Faq.index'])->middleware('acl:233');
        Route::get('/faqs/list-view', ['uses' => 'FaqController@listView', 'as' => 'admin.Faq.list_view'])->middleware('acl:234');
        Route::get('/faqs/create', ['uses' => 'FaqController@create', 'as' => 'admin.Faq.create'])->middleware('acl:235');
        Route::post('/faqs', ['uses' => 'FaqController@create', 'as' => 'admin.Faq.store'])->middleware('acl:235');
        Route::get('/faqs/{id}', ['uses' => 'FaqController@show', 'as' => 'admin.Faq.show'])->middleware('acl:236');
        Route::get('/faqs/{id}/edit', ['uses' => 'FaqController@edit', 'as' => 'admin.Faq.edit'])->middleware('acl:237');
        Route::put('/faqs/{id}', ['uses' => 'FaqController@edit', 'as' => 'admin.Faq.update'])->middleware('acl:237');
        Route::delete('/faqs/{id}', ['uses' => 'FaqController@destroy', 'as' => 'admin.Faq.destroy'])->middleware('acl:238');
        Route::get('/faqs/file_manager/connector', ['uses' => 'FaqController@showFileManagerConnector', 'as' => 'admin.Faq.showFileManagerConnector'])->middleware('acl:239');
        Route::post('/faqs/file_manager/connector', ['uses' => 'FaqController@showFileManagerConnector', 'as' => 'admin.Faq.showFileManagerConnector'])->middleware('acl:239');
        Route::get('/faqs/file_manager/{view}/{input_id?}', ['uses' => 'FaqController@showFileManager', 'as' => 'admin.Faq.showFileManager'])->middleware('acl:240');
    });
